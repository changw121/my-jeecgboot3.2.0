...
//		System.out.println(pageList.getRecords().get(0).getType());
		System.out.println("----------字典");
		System.out.println(pageList.getRecords().get(0));
//		System.out.println(pageList.getRecords().size());

//		for(int i = 0; i<pageList.getRecords().size(); i++){
//			String type_id = pageList.getRecords().get(i).getType();
////			System.out.println(pageList.getRecords().get(i).getType().getClass().getName());  //String
////			System.out.println(sysDictService.queryDictTypeByType(type_id));
//
//			pageList.getRecords().get(i).setType(sysDictService.queryDictTypeByType(type_id));
//
////			System.out.println("-----end---------");
////			System.out.println(sysDictService.queryDictTypeByType(type_id));
////			pageList.getRecords().get(i).getType()=sysDictService.queryDictTypeByType(type_id);
//		}
//		System.out.println(sysDictService.queryDictTypeByType("08e6b9dc3c04489c8e1ff2ce6f105aa4"));

		result.setSuccess(true);
		result.setResult(pageList);

//		System.out.println(result);   只打印result是一个地址，需要获取result里面的内容需要result.方法
